...
custom_font = ("Candice Cyr Regular", 12)
...
class LoginWindow(tk.Toplevel):
    ...
    def init_login_window(self):
        ...
        self.logo_img = tk.PhotoImage(file=r'C:\Users\RIfit\Desktop\Картинки для проекта\logo.gif')
    ...
    def check_login(self):
        ...
        if login == "Копатыч" and password == "УкусиМеняПчола":
            ...
            self.main_app.show()  # Показываем главное окно
            self.main_app.play_success_sound()  # Воспроизводим звук
        else:
...
class Main(tk.Frame):
    ...
    def show(self):
        self.master.deiconify()  # Показываем главное окно

    def play_success_sound(self):
        pygame.mixer.music.load(r'C:\Users\RIfit\Desktop\Картинки для проекта\success_sound.mp3')
...
class DB:
    ...
    def insert_data(self, honeyname, money, total):
        self.c.execute('''INSERT INTO Honey(name, costs, sum) VALUES (?,?,?)''', (honeyname, money, total))
        self.con.commit()
...
if __name__ == "__main__":
    ...
    # Сокно входа и ссылка на главное окно
